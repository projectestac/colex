...
/**
 * Bean to processes all the requests from the JSP portal.jsp, where is implemented the portal page of the application
 * @author ogalzorriz
 * @version 1.0
 */
public class ColexPortalBean extends ColexMainBean 
{
    /**
     * Method that overrides the method from the MainBean because portal.jsp is a public page
     * @return true
     */

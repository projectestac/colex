...
public class DataBase 
{
     ...
     */
    public final static String DBCONF_PATH = "/edu/xtec/colex/server/";
    /**
     * Database file configuration
     */
    public final static String DBCONF_FILE = "colex_db.properties";
    /**
    ...
    public static Properties getDBProperties() throws ServerException
    {
        if (pDB==null){
            pDB = new Properties();
            try{
                InputStream isl = DataBase.class.getResourceAsStream (DBCONF_PATH+DBCONF_FILE);

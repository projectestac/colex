...
/**
 * Class that represents the Field Definition of type 'boolean'
 * @author ogalzorriz
 * @version 1.0
 */
public class FieldDefBoolean extends FieldDef{
    
    /**
     * Creates a new FieldDefBoolean
     */
    public FieldDefBoolean() 
    {
        type="boolean";
    }
     ...
     */
    public FieldDefBoolean(String sName, String sType) 
    {
        super(sName,sType);
    }
     ...
     * @return a Vector containing the String '='
     */
